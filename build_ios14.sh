...
# Keep MoltenVK PBX records. The static Godot library still references Vulkan
# symbols at link time even when the selected runtime backend is native Metal.
changes.append("kept MoltenVK PBX references for static Vulkan symbol resolution")
